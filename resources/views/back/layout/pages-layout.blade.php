	...
	<body>
		...
		<div class="left-side-bar">
			<div class="brand-logo">
				<a href="index.html">
					<img src="/back/vendors/images/laravel-logo.png" alt="" class="dark-logo" />
					<img
						src="/back/vendors/images/laravel-logo.png"
						alt=""
						class="light-logo"
					/>
				</a>
				...
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						@if (Route::is('admin.*'))
							...
							<li>
								<a
									href="{{ route('admin.profile') }}" class="dropdown-toggle no-arrow {{ Route::is('admin.profile') ? 'active' : '' }}">
